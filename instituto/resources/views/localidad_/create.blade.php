...
<form action="{{ url('/localidades')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
{{ csrf_field() }}
...
<div class="col-md-6 col-sm-6">
<input type="text" class="form-control {{$errors->has('nombre')?'is-invalid':''}}" name="nombre" id="nombre" value="{{isset($localidad->nombre)?$localidad->nombre:old('nombre')}}">
