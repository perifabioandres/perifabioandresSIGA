...
@endif
  ...
  <form action="{{ url('alumnos')}}" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
   ...
   <!-- Campo DNI-->
    ...
    <div class="col-md-6 col-sm-6">
    <input type="number" min=0 class="form-control {{$errors->has('dni')?'is-invalid':''}}" name="dni" id="dni" value="{{ isset($alumno->dni)?$alumno->dni:old('dni')}}">
    ...
    <div class="col-md-6 col-sm-6">  
    <select id="sexo" class="custom-select{{$errors->has('sexo')?'is-invalid':''}}" name="sexo" id="sexo" value="{{ isset($alumno->sexo)?$alumno->sexo:old('sexo')}}">
    ...
    <div class="col-md-6 col-sm-6">  
    <input type="number" min=0 class="form-control {{$errors->has('numero')?'is-invalid':''}}" name="numero" id="numero" value="{{ isset($alumno->numero)?$alumno->numero:old('numero')}}">
