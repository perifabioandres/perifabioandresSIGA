        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            @if (!empty($departamento))
              ...
              <form action="//departamentos/edit/{{$departamento->id}}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                  ...
                  @if(count($paises))
                      <select class="form-control" name="pais_id" required disabled="disabled">
                          @foreach($paises as $pais)
                              <option value="{{$pais->id}}" {{ ($departamento->provincia->pais->id ==  $pais->id && old('pais_id') == '') || old('pais_id') == $pais->id ? 'selected' : '' }}>{{$pais->nombre}}</option>
                          @endforeach
                      </select>
                  @else
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="hidden" name="old_provincia_id" value="{{old('provincia_id') ? old('provincia_id') : $departamento->provincia->id}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="nombre" name="nombre" class="form-control col-md-7 col-xs-12 @if ($errors->has('nombre')) parsley-error @endif" value="{{ old('nombre') ? old('nombre') : $departamento->nombre }}" autofocus required >
                ...
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <a href="//departamentos" class="btn btn-primary">Cancelar</a>
