        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
              ...
              <form action="//localidades/create" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">

              	{{ csrf_field() }}

                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pais_id">Pais<span class="required">*</span></label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="hidden" name="old_provincia_id" value="{{old('provincia_id') ? old('provincia_id') : ''}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="hidden" name="old_departamento_id" value="{{old('departamento_id') ? old('departamento_id') : ''}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="cp" name="cp" class="form-control col-md-7 col-xs-12 @if ($errors->has('cp')) parsley-error @endif" value="{{ old('cp') ? old('cp') : '' }}" autofocus required>
